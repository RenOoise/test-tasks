...
### 4. Составить SQL запрос в базу Zabbix для получения списка Топ 10 неподдерживаемых айтемов. 
 - Не понял какой именно топ нужно получить: Топ хостов с не поддерживаемыми итемами или топ итемов которые когда либо были не поддерживаемыми, или топ неподддерживаемых итемов которые активны сейчас.
 - Так же не смог воспроизвести данную ситуацию на стенде, не откуда отталкиваться для составления запроса.
 - А так, я бы выбрал все проблемы с тегом unsupported, сгруппировал бы из по итемам, и вывел бы топ 10 итемов по убыванию
